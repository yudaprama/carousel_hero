...
class CarouselState extends State<Carousel> {
  ...
  Widget build(BuildContext context) {
    final List<Widget> listImages = widget.images.map((item) {
      String src = item['src'];
      String tag = item['tag'];
      return Hero(
        tag: tag,
        child: Container(
          decoration: BoxDecoration(
            ...
            image: DecorationImage(
              ...
              image: src.contains(RegExp(r"^(http|https)://", caseSensitive: true)) ? NetworkImage(src) : AssetImage(src),
              fit: widget.boxFit,
            )),
          child: Container(),
        )
